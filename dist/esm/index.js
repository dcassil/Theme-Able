            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 2:
                        ...
                        return _context.abrupt("return", jsxs(Fragment, { children: [jsx("style", Object.assign({ scoped: true }, { children: getComponentStyles({ themeItemData: themeItemData }) })), children] }));
...
function ComponentWrapper(_ref) {
    ...
    return jsxs(Fragment, { children: [jsx("style", Object.assign({ scoped: true }, { children: getComponentStyles({ themeItemData: themeItemData }) })), children] });
}
...
function WithTheme(Child) {
    return function (props) {
        ...
        return function () {
            return jsx(Wrapper, Object.assign({ instanceId: props.instanceId, tag: props.tag }, { children: jsx(Child, Object.assign({}, props, {
